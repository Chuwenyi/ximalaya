...
import com.r.himalaya.utils.ImageBlur;
...
public class DetailActivity extends BaseActivity implements IAlbumDetailViewCallback, UILoader.OnRetryClickListener, TrackListAdapter.ItemClickListener, IPlayCallback, ISubscriptionCallback {
    ...
    private AlbumDetialPresenter mAlbumDetailPresenter;
    ...
    private ISubscriptionPresent mSubscriptionPresenter;
    ...
    private void initPresenter() {
        //这个是专辑详情的presenter.
        mAlbumDetailPresenter = AlbumDetialPresenter.getInstance();
...
//        //订阅相关的presenter.
    ...
    public void onDetailListLoad(List<Track> tracks) {
        ...
        //更新/设置UI数据
        mDetailListAdapter.setDate(tracks);
    }
