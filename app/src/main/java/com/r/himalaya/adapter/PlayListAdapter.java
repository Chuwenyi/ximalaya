...
//        设置数据
        ...
        TextView trackTitleTv = holder.itemView.findViewById(R.id.track_list_tv);
        //设置字体颜色
        trackTitleTv.setTextColor( BaseApplication.getAppContext().getResources().
                getColor(playingIndex ==
                        position ?R.color.colorPrimary:R.color.sub_text_title));
